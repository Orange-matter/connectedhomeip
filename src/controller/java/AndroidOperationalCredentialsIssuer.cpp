                                                                                ...
                                                                                MutableByteSpan & noc)
{
    ...
    // Orange customization: derivate NOC from ICA (and not RCA)
    return GenerateOperationalCertificate(mIntermediateIssuer, icac, pubkey, fabricId, nodeId, cats, mNow, mNow + mValidity, noc);
}
